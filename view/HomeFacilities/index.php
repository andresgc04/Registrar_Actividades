...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container-fluid">
                    <section class="mt-2 mb-3">
                        <div class="d-flex justify-content-end">
                            <button id="goNewFacilityBtn" type="button" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Nueva Sub-Compañia</button>
                        </div>
                    </section>
                    <!-- Main row -->
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="facilities_table" class="table table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Districto</th>
                                                    <th>Sub-Districto</th>
                                                    <th>Abreviatura de la Sub-Districto</th>
                                                    <th>Estado</th>
                                                    <th>Acciones</th>
                                                </tr>
                                            </thead>
    ...
    <script type="text/javascript" src="home_facilities.js"></script>
</body>
</html>
