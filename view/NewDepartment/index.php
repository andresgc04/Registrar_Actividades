...
?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Registrar Nuevo Departamento</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="departmentName" name="departmentName" class="form-control" placeholder="Ingrese el nombre del departamento">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="abbreviationDepartment">Abreviatura del Nombre del Departamento:</label>
                                                        <input type="text" id="abbreviationDepartment" name="abbreviationDepartment" class="form-control" placeholder="Ingrese la abreviatura del nombre del Departamento">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script type="text/javascript" src="new_department.js"></script>
    </body>
