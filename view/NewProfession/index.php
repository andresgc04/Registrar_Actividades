...
?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Registrar Nueva Profesion</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="profession" name="profession" class="form-control" placeholder="Ingrese el nombre de la profesion.">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script type="text/javascript" src="new_professions.js"></script>
    </body>
    </html>
<?php
} else {
