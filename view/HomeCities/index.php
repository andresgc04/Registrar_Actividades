...
?>
    ...
    <head>
        ...
        <title>Actividades | Ciudades</title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="container-fluid">
                        <section class="mt-2 mb-3">
                            <div class="d-flex justify-content-end">
                                <button id="goNewCitiesBtn" type="button" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Nueva Ciudad</button>
                            </div>
                        </section>
                        <!-- Main row -->
                        <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="cities_table" class="table table-striped table-hover">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Pais</th>
        ...
        <script type="text/javascript" src="home_cities.js"></script>
    </body>
