...
?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="container-fluid">
                        <section class="mt-2 mb-3">
                            <div class="d-flex justify-content-end">
                                <button id="goNewRolBtn" type="button" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Nuevo Rol</button>
                            </div>
                        </section>
                        <!-- Main row -->
                        <div class="row">
        ...
        <script type="text/javascript" src="home_roles.js"></script>
    </body>
